windowFunctions['Add a Venue'] = function (evt) {
    ...
    function submitForm() {
        ...
        Cloud.Places.create({
            ...
            if (e.success) {
                alert('Created!');
                name.value = address.value = city.value = state.value = postalCode.value = phone.value = web.value ='';
            }
            else {
                error(e);
            }
